...
export default function Navbar() {
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-4 flex origin-bottom h-full max-h-14 md:hidden">
      ...
      <div className="pointer-events-none fixed left-[calc(50%-400px)] top-1/2 -translate-y-1/2 z-30 hidden md:flex flex-col">
